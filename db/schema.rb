...
ActiveRecord::Schema.define(version: 2018_06_25_085426) do
  ...
  create_table "answers", force: :cascade do |t|
    ...
    t.index ["question_id", "best"], name: "index_answers_on_question_id_and_best", unique: true, where: "best=1"
  ...
  create_table "question_category_links", force: :cascade do |t|
